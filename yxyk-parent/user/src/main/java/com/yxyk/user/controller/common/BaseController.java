package com.yxyk.user.controller.common;

import com.alibaba.fastjson.JSONObject;
import com.yxyk.user.bean.common.JSONResponse;
...
public abstract class BaseController {
    ...
    public AppUserInfo getUser() {
        return (AppUserInfo) SecurityUtils.getSubject().getSession().getAttribute(SysConst.SHIRO_USER_SESSION_NAME);
    }
